...
# Unit tests for MuxRuby::CreateWebInputRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MuxRuby::CreateWebInputRequest do
  let(:instance) { MuxRuby::CreateWebInputRequest.new }

  describe 'test an instance of CreateWebInputRequest' do
    it 'should create an instance of CreateWebInputRequest' do
      expect(instance).to be_instance_of(MuxRuby::CreateWebInputRequest)
    end
  end
