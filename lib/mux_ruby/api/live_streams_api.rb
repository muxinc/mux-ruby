...
module MuxRuby
  class LiveStreamsApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_live_stream_static_renditions(live_stream_id, opts = {})
      delete_live_stream_static_renditions_with_http_info(live_stream_id, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def delete_live_stream_static_renditions_with_http_info(live_stream_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LiveStreamsApi.delete_live_stream_static_renditions ...'
      end
      # verify the required parameter 'live_stream_id' is set
      if @api_client.config.client_side_validation && live_stream_id.nil?
        fail ArgumentError, "Missing the required parameter 'live_stream_id' when calling LiveStreamsApi.delete_live_stream_static_renditions"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"LiveStreamsApi.delete_live_stream_static_renditions",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: LiveStreamsApi#delete_live_stream_static_renditions\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [LiveStreamResponse]
    def update_live_stream_static_renditions(live_stream_id, update_live_stream_new_asset_settings_static_renditions_request, opts = {})
      data, _status_code, _headers = update_live_stream_static_renditions_with_http_info(live_stream_id, update_live_stream_new_asset_settings_static_renditions_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(LiveStreamResponse, Integer, Hash)>] LiveStreamResponse data, response status code and response headers
    def update_live_stream_static_renditions_with_http_info(live_stream_id, update_live_stream_new_asset_settings_static_renditions_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LiveStreamsApi.update_live_stream_static_renditions ...'
      end
      # verify the required parameter 'live_stream_id' is set
      if @api_client.config.client_side_validation && live_stream_id.nil?
        fail ArgumentError, "Missing the required parameter 'live_stream_id' when calling LiveStreamsApi.update_live_stream_static_renditions"
      end
      ...
      if @api_client.config.client_side_validation && update_live_stream_new_asset_settings_static_renditions_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_live_stream_new_asset_settings_static_renditions_request' when calling LiveStreamsApi.update_live_stream_static_renditions"
      end
      # resource path
      local_var_path = '/video/v1/live-streams/{LIVE_STREAM_ID}/new-asset-settings/static-renditions'.sub('{' + 'LIVE_STREAM_ID' + '}', CGI.escape(live_stream_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"LiveStreamsApi.update_live_stream_static_renditions",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: LiveStreamsApi#update_live_stream_static_renditions\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
